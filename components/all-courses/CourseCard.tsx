    ...
    >
      ...
      <div style={{ position: 'relative', height: 200, overflow: 'hidden', flexShrink: 0 }}>
        ...
        {s.badge && (
          <span style={{
            ...
            fontSize: '0.65rem', fontWeight: 800, fontFamily: 'Inter, sans-serif',
        ...
        <span style={{
          ...
          fontFamily: 'Inter, sans-serif', padding: '5px 12px', borderRadius: 8,
      ...
      <div style={{ padding: '22px 22px 20px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        <div style={{
          ...
          fontFamily: 'Inter, sans-serif', fontSize: '0.75rem', color: '#374151',
        }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 16 }}>
          ...
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.78rem', fontWeight: 700, color: '#0B1A3D' }}>{s.rating}</span>
          <span style={{ fontFamily: 'Inter, sans-serif', fontSize: '0.72rem', color: '#9CA3AF' }}>({s.students})</span>
        </div>
        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 20 }}>
          {s.courses.slice(0, 4).map((c) => (
            <span key={c} style={{
              fontFamily: 'Inter, sans-serif', fontSize: '0.66rem', fontWeight: 600,
