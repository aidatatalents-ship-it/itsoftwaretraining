    ...
    <section style={{ padding: '80px 0', background: '#F8F9FC' }}>
      <div className="container">
        <div className="section-header">
          ...
          <h2>The IT Software Training <span style={{ color: '#F26522', fontStyle: 'italic' }}>Difference</span></h2>
        ...
        <div className={styles.midCta}>
          ...
          <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap', flexShrink: 0 }}>
            <Link href="/contact" className="btn-white">Book Free Demo</Link>
            <a href="tel:+918147111010" style={{
