...
export const courseTree: ParentCourse[] = [
  ...
  // ─── SAP ──────────────────────────────────────────
  {
    ...
    children: [
      ...
      {
        slug: 'sap-hr',
        href: '/sap/hr-training',
        title: 'SAP HR/HCM',
        tagline: 'Personnel Admin · Payroll · SuccessFactors',
        duration: '3 Months',
        level: 'Beginner to Advanced',
        salary: '₹5–18 LPA',
        icon: '👥',
        badge: 'HR Professionals',
        highlights: ['Organisational Management', 'Payroll & Time Management', 'ESS/MSS & SuccessFactors', 'HCM Certification Prep'],
      },
      {
        slug: 'sap-s4hana',
        href: '/sap/s4hana-training',
        title: 'SAP S/4HANA',
        tagline: 'Next-Gen ERP · Fiori · Migration · Embedded Analytics',
        duration: '3–4 Months',
        level: 'Intermediate to Advanced',
        salary: '₹8–28 LPA',
        icon: '🚀',
        badge: 'Future of SAP',
        highlights: ['S/4HANA Architecture & Universal Journal', 'Fiori Launchpad & App Configuration', 'ECC to S/4HANA Migration', 'Embedded Analytics & SAC'],
      },
      {
        slug: 'sap-basis',
        href: '/sap/basis-training',
        title: 'SAP BASIS',
        tagline: 'System Admin · Transport · Security · HANA',
        duration: '3 Months',
        level: 'Intermediate',
        salary: '₹6–22 LPA',
        icon: '⚙️',
        badge: 'Technical',
        highlights: ['System Landscape & Client Admin', 'Transport Management (STMS)', 'User Security & Authorisations', 'HANA & S/4HANA BASIS'],
      },
    ],
  },
  ...
  // ─── PYTHON & AI ──────────────────────────────────
  {
    ...
    description: 'From Python basics to production-grade AI systems and Generative AI applications. Our data science training in Bangalore builds real skills through hands-on projects in NLP, computer vision, LLMs, and MLOps — the most in-demand skill globally in 2026.',
    icon: '🐍',
    color: '#059669',
    bg: '#ECFDF5',
    children: [
      {
        slug: 'python',
        href: '/python/python-training',
        title: 'Python Training',
        tagline: 'Core Python · OOP · Django · Flask · Automation',
        duration: '2–3 Months',
        level: 'Beginner',
        salary: '₹5–18 LPA',
        icon: '🐍',
        badge: 'Foundation',
        highlights: ['Core Python & OOP', 'Django & Flask Web Dev', 'REST APIs & Databases', 'Automation & Scripting'],
      },
      {
        slug: 'data-science',
        href: '/python/data-science-training',
        title: 'Data Science',
        tagline: 'Pandas · NumPy · SQL · Power BI · Statistics',
        duration: '3–4 Months',
        level: 'Beginner to Intermediate',
        salary: '₹7–28 LPA',
        icon: '📊',
        badge: 'Most Popular',
        highlights: ['Pandas & NumPy for Analysis', 'Statistics & Hypothesis Testing', 'Power BI & Tableau', 'SQL for Data Science'],
      },
      {
        slug: 'machine-learning',
        href: '/python/machine-learning-training',
        title: 'Machine Learning',
        tagline: 'Scikit-learn · TensorFlow · PyTorch · NLP · MLOps',
        duration: '3–5 Months',
        level: 'Intermediate to Advanced',
        salary: '₹10–35 LPA',
        icon: '🤖',
        badge: 'High Value',
        highlights: ['ML Algorithms & Deep Learning', 'NLP & Computer Vision', 'TensorFlow & PyTorch', 'AWS SageMaker & MLOps'],
      },
      {
        slug: 'generative-ai',
        href: '/python/generative-ai-training',
        title: 'Generative AI',
        tagline: 'LLMs · LangChain · RAG · Prompt Engineering · Fine-Tuning',
        duration: '2–3 Months',
        level: 'Intermediate',
        salary: '₹12–45 LPA',
        icon: '✨',
        badge: '🔥 Hottest 2026',
        highlights: ['LLMs (GPT, Gemini, Llama)', 'LangChain & RAG Systems', 'Prompt Engineering', 'AI App Deployment'],
      },
    ],
  },
