...
export const salesforceModules: SFModule[] = [
  ...
  {
    moduleSlug: 'developer-training',
    detailKey: 'salesforce-developer',
    serviceSlug: 'salesforce',
    title: 'Salesforce Developer Training in Bangalore',
    h1: 'Salesforce Developer Training in Bangalore — Apex, Triggers, SOQL, REST API & PD1 Certification',
    short: 'Salesforce Developer',
    description: 'Become a certified Salesforce Platform Developer — learn Apex programming, triggers, batch jobs, REST/SOAP API integration, Visualforce and full PD1 certification preparation. Taught by Salesforce developers with 10+ years of enterprise implementation experience.',
    duration: '2–3 Months',
    salary: '₹5–20 LPA',
    demand: 'Very High',
    students: '500+',
